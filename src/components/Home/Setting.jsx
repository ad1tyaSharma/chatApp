...

          {
            ...
            <div className="flex justify-around items-center flex-col p-2">
                {
                    userData ? <div className='flex flex-col p-3 border dark:border-gray-500 rounded-lg dark:bg-gray-600 '> <img className='h-16 lg:w-32  w-16 lg:h-32 rounded-full' src={userData.photoURL} alt="profile picture" />
                        <div className='my-2 flex items-center justify-around text-white'>
                            <input type="file" name="image" id="image" className='hidden'  onChange={e=>setImageInput(e.target.files[0])} />
                            {
                                !imageInput ? 
                                ...
                                :
                                <button className='hover:text-blue-600' onClick={handleUpload}><Upload></Upload></button>
                            }
                            <button disabled={imageUrl ? false : true} style={{opacity : imageUrl ? 1 : 0.5}} onClick={handleImageUpdate} className='hover:text-blue-600'><SaveIcon></SaveIcon></button>
                        </div>
                     </div>:
                ...
                
                {
                    ...
                    <input type="text" readOnly={!nameChange} id="search" value={name} onChange={e=>setName(e.target.value)} class="block w-full py-4 px-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" required/>
                    
                        {
                            nameChange ? <button onClick={()=>{
                            ...
                            :
                            <button onClick={()=>setNameChange(true)}  class="text-white absolute right-2 bottom-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><EditIcon></EditIcon></button>
                        }
                   
                    
                </div>
                    : 
                    (<div role="status" className="max-w-sm animate-pulse"><div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-48 mb-4"></div></div>)
                }
                                    ...
                                    
                {
                    userData ?
                    <div>
                <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" onClick={()=>setShowDropdown(!showDropdown)} class={`w-full capitalize flex justify-between text-white bg-blue-700 hover:bg-blue-800  focus:outline-none  font-medium ${showDropdown ? 'rounded-tr-lg rounded-tl-lg' : "rounded-lg"} text-sm px-5 py-2.5  items-center dark:bg-blue-600 dark:hover:bg-blue-700`} type="button"> <p>{userData.status}</p> <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                </svg></button>
                               {
                                showDropdown ? 
                                <div id="dropdown" class="z-10  bg-white divide-y divide-gray-100 rounded-br-lg rounded-bl-lg shadow w-full dark:bg-gray-600">
                                ...
                                <li>
                                    ...
                                    }}  class="block px-4 py-2 hover:bg-gray-100 cursor-pointer dark:hover:bg-gray-500 dark:hover:text-white">Idle</div>
                                </li>
                                <li>
                                    <div  onClick={()=>{
                                        ...
                                        setShowDropdown(false)
                                    }}  class="block px-4 py-2 hover:bg-gray-100 cursor-pointer dark:hover:bg-gray-500 dark:hover:text-white">Busy</div>
                                </li>
                                </ul>
                            </div>
                            : <></>
                    ...
                    <span className='ml-2 text-white text-md capitalize'></span></div>
            ...
            <div className="mt-2 lg:w-[70vw] w-[60vw] rounded-lg dark:border-gray-400 bg-gray-700 px-4 py-2">
                <p className='text-lg text-gray-400 font-[500]'>About</p>
                {
                    ...
                    <input type="text" readOnly={!changeAbout} onChange={(e)=>setAbout(e.target.value)}  id="default-search" value={ about} class="block w-full p-4  text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos..." />
                    {
                        changeAbout ?<button type="submit" onClick={()=>
                        {
                        ...
                        :
                        <button type="submit" onClick={()=>setChangeAbout(true)} class="text-white absolute right-2 bottom-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><EditIcon></EditIcon></button>
            ...
            <div className='mt-2 rounded-lg dark:border-gray-400 bg-gray-700 px-4 py-2'>
                    ...
                    {
                        usernameChange ?<button type="submit" onClick={async()=>
                        {
                        ...
                        :
                        <button type="submit" onClick={()=>setUsernameChange(true)} class="text-white absolute right-2 bottom-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><EditIcon></EditIcon></button>

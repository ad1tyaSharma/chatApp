      ...
      >
        <div className="flex justify-between w-full">
          ...
          <button
            ...
            className="text-white px-2  py-1 rounded-full hover:bg-gray-700"
          >
          ...
          {showDropdown ? (
            <div
              id="dropdownDots"
              class="z-10 absolute right-2 top-20 bg-white divide-y divide-gray-100 rounded-lg shadow w- dark:bg-gray-700 dark:divide-gray-600"
            >
              <ul
              ...
              >
                ...
                <li>
                  <button onClick={handleSignout} class="block px-4 py-2 ">
                    Logout
                  </button>
                </li>
              </ul>
        ...
        <div className="flex justify-around items-center flex-col p-2">
          ...
          {userData ? (
            <h5 className="text-xl text-white font-[600]">{userData.name}</h5>
          ) : (
          ...
          <div className={`mb-4 flex items-center`}>
            ...
            <span className="ml-2 text-white text-md capitalize">
        ...
        <div className="mt-2 lg:w-[75vw] w-[65vw] rounded-lg dark:border-gray-400 bg-gray-700 px-4 py-2">
          ...
          {userData ? (
            <p className="text-md text-gray-200 font-[400]">
              {" "}
              {userData.about ? userData.about : "Not Specified"}
            </p>
          ) : (
        ...
        <div className="mt-2 lg:w-[75vw] w-[65vw]">
          <div className="mt-2 rounded-lg dark:border-gray-400 bg-gray-700 px-4 py-2">
            <p className="text-lg text-gray-400 font-[500]">
              ...
              {userData && !userData.username ? (
                <span className="italic text-xs">
                  (if username is not specified, you'll not be discovered in
                  search)
                </span>
              ) : (
                <></>
            ...
            {userData ? (
              <p className="text-md text-gray-200 font-[400]">
                {userData.username ? userData.username : "Not Specified"}
              </p>
            ) : (
              <div role="status" className="max-w-sm animate-pulse mt-1">
          ...
          <div className="mt-2 rounded-lg dark:border-gray-400 bg-gray-700 px-4 py-2">
            ...
            {userData ? (
              <p className="text-md text-gray-200 font-[400]">
                {userData.phoneNumber ? userData.phoneNumber : "Not specified"}
              </p>
            ) : (
              <div role="status" className="max-w-sm animate-pulse mt-1">

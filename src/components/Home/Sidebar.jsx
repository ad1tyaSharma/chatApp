    ...
    <div className="absolute bottom-0 left-0 w-[100vw]">
      <div className="w-[100vw] shadow lg:flex lg:flex-col flex flex-row justify-between items-center fixed lg:relative z-40 bottom-0 bg-white dark:bg-zinc-600 ">
        ...
        <div className="w-[100vw] mx-auto lg:my-auto bg-gray-800">
          <ul
            id="tabs"
            className="w-[100vw] flex flex-row justify-center nav-tabs"
          >
            <li className="flex-grow lg:flex-grow-0">
              <button
                id="default-tab"
                onClick={() => setMenu(1)}
                className="tab-button flex relative items-center justify-center mx-auto h-14 w-14 leading-[14px] hover:bg-zinc-500 dark:text-violet-100/80 group/tab my-2 rounded-lg"
              >
                <div className="absolute items-center hidden -top-10 ltr:left-0 group-hover/tab:flex rtl:right-0">
                  <div className="absolute -bottom-1 left-[40%] w-3 h-3 rotate-45 bg-black"></div>
                  <span
                    className={`relative z-10 p-2 text-xs leading-none text-gray-50 whitespace-no-wrap bg-black rounded shadow-lg`}
                  >
                    Profile
                  </span>
                </div>
                <i
                  className={`text-2xl ri-user-2-line ${
                    menu == 1 ? "text-violet-500" : "text-gray-300"
                  }`}
                ></i>
              </button>
            </li>
            <li className="flex-grow lg:flex-grow-0">
              <button
                onClick={() => setMenu(2)}
                className="tab-button hover:bg-zinc-500 relative flex items-center justify-center mx-auto h-14 w-14 leading-[14px] group/tab my-2 rounded-lg dark:text-violet-100/80"
              >
                <div className="absolute items-center hidden -top-10 ltr:left-0 group-hover/tab:flex rtl:right-0">
                  <div className="absolute -bottom-1 left-[40%] w-3 h-3 rotate-45 bg-black"></div>
                ...
                <i
                  className={`text-2xl ri-message-3-line ${
                    menu == 2 ? "text-violet-500" : "text-gray-300"
                  }`}
                ></i>
              </button>
            </li>
            ...
            <li className="flex-grow lg:flex-grow-0">
              ...
              >
                ...
                <i
                  className={`text-2xl ri-contacts-line ${
                    menu == 3 ? "text-violet-600" : "text-gray-300"
                  }`}
                ></i>
              </button>
            </li>
            <li className="flex-grow lg:flex-grow-0">
              <button
                onClick={() => setMenu(4)}
                className="tab-button relative hover:bg-zinc-500 flex items-center justify-center mx-auto h-14 w-14 leading-[14px] group/tab my-2 rounded-lg active dark:text-violet-100/80"
              >
                <div className="absolute items-center hidden -top-10 ltr:left-0 group-hover/tab:flex rtl:right-0">
                  <div className="absolute -bottom-1 left-[40%] w-3 h-3 rotate-45 bg-black"></div>
                  <span className="relative z-10 p-2 text-xs leading-none text-white whitespace-no-wrap bg-black rounded shadow-lg">
                ...
                <i
                  className={`text-2xl ri-settings-2-line ${
                    menu == 4 ? "text-violet-600" : "text-gray-300"
                  }`}
                ></i>
              </button>
            </li>

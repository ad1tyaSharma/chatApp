...
const Contact = ({ user, setStage, setMenu }) => {
  ...
  return (
    <div className="w-[100vw] flex justify-center items-center h-[95vh] ">
      ...
      <div
        style={{ opacity: `${openModal ? 0.2 : 1}` }}
        className="flex flex-col justify-around items-center lg:w-[80vw] w-[70vw] p-6 min-h-[50vh] bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 "
      >
